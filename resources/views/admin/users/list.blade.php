    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Danh sách tài khoản sách</h4>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="white-box">
                    ...
                    <a href="{{route('users.list')}}" class="btn btn-info text-white">Tất cả tài khoản</a>
                    ...
                    <div class="form-group row justify-content-between m-0 p-0">
                        ...
                        <div class="col-sm-6 my-3 d-flex justify-content-end align-items-center">
                            <a href="{{route('users.trash.list')}}" class="btn btn-success text-white me-2">Danh sách tài khoản đã xóa</a>
                            <form action="{{route('users.delete-list')}}" class="d-inline" method="post" id="form-delete">
                                @csrf
                        ...
                        <table class="table text-nowrap text-center" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$user->role}}</td>
                                    <td>
                                        <a href="{{route('users.edit', $user->id)}}" class="me-2"><i class="fas fa-edit"></i></a>
                                        <form action="{{route('users.delete', $user->id)}}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-link " onclick="return confirm('Xác nhận xóa tài khoản?')">
