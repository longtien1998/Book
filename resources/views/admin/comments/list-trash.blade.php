    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Danh sách bình luận sách đã xóa</h4>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <form method="POST" action="{{route('comments.trash.search')}}">
                            @csrf
                            <div class="d-flex">
                ...
                <div class="white-box">
                    <a href="{{route('comments.trash.list')}}" class="btn btn-info text-white">Tất cả bình luận đã xóa</a>
                    <div class="form-group row justify-content-between m-0 p-0">
                        ...
                        <div class="col-sm-6 my-3 d-flex justify-content-end align-items-center gap-2">
                            <form action="{{route('comments.trash.restore')}}" class="d-inline" method="post" id="form-restore">
                                ...
                                <button type="submit" class="btn btn-primary" onclick="return confirm('Xác nhận khôi phục bình luận đã chọn?')">Khôi phục bình luận</button>
                            </form>
                            <a href="{{route('comments.trash.restore-all')}}" class="btn btn-success text-white">Khôi phục tất cả bình luận</a>
                        ...
                        <table class="table text-nowrap text-center" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('comments.trash.destroy',$comment->id)}}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @php $stt++; @endphp
                                @endforeach
