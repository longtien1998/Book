        ...
        <!-- Row -->
            <div class="row">
                ...
                <div class="col-lg-4 col-xlg-3 col-md-12">
                    <div class="white-box">
                        <div class="user-bg"> <img width="100%" alt="user" src="{{asset('upload/users/'.old('avatar',$user->avatar))}}">
                            <div class="overlay-box">
                                <div class="user-content">
                                    <a href="javascript:void(0)"><img src="{{asset('upload/users/'.old('avatar',$user->avatar))}}"
