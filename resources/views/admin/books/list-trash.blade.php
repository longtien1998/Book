    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Danh sách sách đã xóa</h4>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <form method="POST" action="{{route('books.trash.search')}}">
                            @csrf
                            <div class="d-flex">
                ...
                <div class="white-box">
                    ...
                    <a href="{{route('books.trash.list')}}" class="btn btn-info text-white">Tất cả sách đã xóa</a>
                    <div class="form-group row justify-content-between m-0 p-0">
                        ...
                        <div class="col-sm-6 my-3 d-flex justify-content-end align-items-center gap-2">
                            <form action="{{route('books.trash.restore')}}" class="d-inline" method="post" id="form-restore">
                                @csrf
                                <input type="text" value="" name="restore_list" id="songs-restore" hidden>
                                <button type="submit" class="btn btn-primary" onclick="return confirm('Xác nhận khôi phục sách đã chọn?')">Khôi phục sách</button>
                            </form>
                            <a href="{{route('books.trash.restore-all')}}" class="btn btn-success text-white">Khôi phục tất cả sách</a>
                            <form action="{{route('books.trash.delete')}}" class="d-inline" method="post" id="form-delete">
                                @csrf
                        ...
                        <table class="table text-nowrap text-center" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('books.trash.destroy',$book->id)}}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @php $stt++; @endphp
                                @endforeach
