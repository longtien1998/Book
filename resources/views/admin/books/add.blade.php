                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" action="{{route('books.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-xl-4 mb-4">
                                    ...
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="text" name="title" placeholder="Sách" class="form-control p-0 border-0">
                                    </div>
                                </div>
                                <div class="form-group col-xl-4 mb-4">
                                    <label for="example-email" class="col-md-12 p-0">Tên tác giả</label>
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="text" placeholder="Tác giả" class="form-control p-0 border-0" name="author">
                                    </div>
                                </div>
                                <div class="form-group col-xl-4 mb-4">
                                    <label for="example-email" class="col-md-12 p-0">Giá</label>
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="number" placeholder="0" class="form-control p-0 border-0" name="price">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group  mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <textarea name="description" class="form-control p-0 border-0" placeholder="Mô tả" rows="4" id=""></textarea>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-xl-6 mb-4">
                                    ...
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="date" class="form-control p-0 border-0" name="publication_year">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-xl-6 mb-4">
                                    ...
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="text" placeholder="Nhà xuất bản" class="form-control p-0 border-0" name="publisher">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xl-4 mb-4">
                                    ...
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="number" placeholder="0" class="form-control p-0 border-0" name="stock_quantity">
                                    </div>
                                </div>
                                <div class="form-group col-xl-4 mb-4">
                                    <label for="example-email" class="col-md-12 p-0">Mã ISBN</label>
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="text" placeholder="ISBN" class="form-control p-0 border-0" name="isbn">
                                    </div>
                                </div>
                                <div class="form-group col-xl-4 mb-4">
                                    <label for="example-email" class="col-md-12 p-0">Ngôn ngữ sách</label>
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="text" placeholder="Tiếng Việt" class="form-control p-0 border-0" name="language">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="file" placeholder="Tác giả" class="form-control p-0 border-0" name="image_url">
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <div class="col-sm-12">
