...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="white-box analytics-info">
                    <h3 class="box-title">Tổng số lượng quảng cáo</h3>
                    <ul class="list-inline two-part d-flex align-items-center mb-0">
                        <li>
                        ...
                        <li class="ms-auto"><span class="counter text-info">{{$totalAds}}</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-md-12">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="white-box analytics-info">
                    <h3 class="box-title">Tổng số lượng thể loại</h3>
                    <ul class="list-inline two-part d-flex align-items-center mb-0">
                        <li>
                        ...
                        <li class="ms-auto"><span class="counter text-info">{{$totalCategory}}</span>
                        </li>
                    </ul>
                </div>
            </div>
